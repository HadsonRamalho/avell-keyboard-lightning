...
pub fn update_zed_theme(theme_config: &ZedTheme) -> io::Result<()> {
    let json = format!(
      ...
      \"themes\": [
        ...
        string_primary = theme_config
            .string_primary
            .clone()
            .unwrap_or("#a6da95".to_string()),
        type_color = theme_config
            .type_color
            .clone()
            .unwrap_or("#eed49f".to_string()),
        icon = theme_config.icon.clone().unwrap_or("#cad3f5".to_string()),
        icon_accent = theme_config
            .icon_accent
            .clone()
            .unwrap_or("#c6a0f6".to_string()),
        panel_indent_guide = theme_config
            .panel_indent_guide
            .clone()
            .unwrap_or("#363a4f99".to_string()),
        editor_indent_guide_active = theme_config
            .editor_indent_guide_active
            .clone()
            .unwrap_or("#5b6078".to_string()),
        scrollbar_thumb_background = theme_config
            .scrollbar_thumb_background
            .clone()
            .unwrap_or("#f4dbd612".to_string()),
        scrollbar_track_border = theme_config
            .scrollbar_track_border
            .clone()
            .unwrap_or("#00000000".to_string()),
        editor_active_line_number = theme_config
            .editor_active_line_number
            .clone()
            .unwrap_or("#f4dbd690".to_string()),
        ghost_element_active = theme_config
            .ghost_element_active
            .clone()
            .unwrap_or("#f4dbd612".to_string()),
    );

    let path = Path::new("/home/hadson/.config/zed/themes/Keyboard.json");
